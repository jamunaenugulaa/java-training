...
public class BaseController {
    ...
    public String updateStudent(@RequestParam("id") int id,ModelMap mp){
        mp.addAttribute("id",id);
        return "updateStudentForm";
    }
    @RequestMapping("/updateStudentResult")
    public String updateStudentResult(StudentModel student){
    ...
    public String updateCourseResult(CourseModel courseModel){
