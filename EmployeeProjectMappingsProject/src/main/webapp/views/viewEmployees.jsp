    ...
    <table border="1">
        ...
        <tr>
            ...
            <td><%= employee.getAddress().getCity() %></td>
              <td><form action="viewProjectOfEmployee"><input type="hidden" name="eid" value="<%= employee.getId() %>" readonly>
               <input type="submit" value="viewProject"> </form></td>
            <td><form action="DeleteEmployee"><input type="hidden" name="eid" value="<%= employee.getId() %>" readonly>
